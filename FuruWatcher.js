...
const infuraID = "5aad6dc093184ec6ac0e2c6deed698b1";
web3 = new Web3(
  new Web3.providers.HttpProvider("https://mainnet.infura.io/v3/" + infuraID)
);
const furucomboProxyContractAddr = "0x57805e5a227937BAc2B0FdaCaA30413ddac6B8E1".toLowerCase();
  ...
  async monitorFuru() {
    ...
    if (block != null && block.transactions != null) {
      ...
      for (let txHash of block.transactions) {
        ...
        // avoid tx is null so that tx.to.toLowerCase() will fail.
        if (tx != null && furucomboProxyContractAddr == tx.to.toLowerCase()) {
