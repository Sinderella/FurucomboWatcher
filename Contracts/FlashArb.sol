...
// Flash loan powered triangular arbitrage for instantiation and execution within the NodeJS bot
contract flashArbitrage{
	...
	// instantiates the OrFeed interface
        OrFeedInterface orfeed= OrFeedInterface(0x8316b082621cfedab95bf4a44a1d4b64a6ffc336);

        //approve the starting token e.g. DAI below
        theToken.approve(0x8316b082621cfedab95bf4a44a1d4b64a6ffc336, 10000000000000000000000000000);

        // Note: the below triangular arb is for demo purposes only
        // The actual arb token and exchanges are subject to the NodeJS bot's price reads and profit calculations
